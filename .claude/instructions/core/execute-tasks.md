...
Execute all assigned parent tasks and their subtasks using#file:.claude/instructions/core/execute-task.md instructions, continuing until all tasks are complete.

<execution_flow>
  LOAD#file:.claude/instructions/core/execute-task.md ONCE
