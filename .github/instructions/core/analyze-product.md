---
description: Analyze Current Product & Install
globs:
alwaysApply: false
version: 1.0
encoding: UTF-8
...
# Analyze Current Product & Install
...
Execute our standard flow for installing  in existing products
...
<execution_prompt>
 #file:.github/instructions/core/plan-product.md
...
<instructions>
  ...
  ALLOW: plan-product.md to create#file:.github/product/ structure
</instructions>
...
<verification_checklist>
  - [ ]#file:.github/product/ directory created
...
<summary_template>
  ...
  I've analyzed your [PRODUCT_TYPE] codebase and set up  with documentation that reflects your actual implementation.
  ...
  3. Start using  for your next feature:
     ```
    #file:.github/instructions/core/create-spec.md
     ```
