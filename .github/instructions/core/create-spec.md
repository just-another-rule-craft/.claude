---
description: Spec Creation Rules for
globs:
alwaysApply: false
version: 1.1
encoding: UTF-8
...
<option_a_flow>
  ...
  <actions>
    1. CHECK #file:.github/product/roadmap.md
...
Use the context-fetcher subagent to read #file:.github/product/mission-lite.md and #file:.github/product/tech-stack.md only if not already in context to ensure minimal context for spec alignment.
...
<date_determination_process>
  <primary_method>
    ...
    <process>
      1. CREATE directory if not exists:#file:.github/specs/
      2. CREATE temporary file:#file:.github/specs/.date-check
...
Use the file-creator subagent to create directory:#file:.github/specs/YYYY-MM-DD-spec-name/ using the date from step 4.
...
Use the file-creator subagent to create the file:#file:.github/specs/YYYY-MM-DD-spec-name/spec.md using this template:
...
Use the file-creator subagent to create the file:#file:.github/specs/YYYY-MM-DD-spec-name/spec-lite.md for the purpose of establishing a condensed spec for efficient AI context usage.
...
<file_template>
  <header>
    ...
    This is the technical specification for the spec detailed in #file:.github/specs/YYYY-MM-DD-spec-name/spec.md
  </header>
</file_template>
...
<file_template>
  <header>
    ...
    This is the database schema implementation for the spec detailed in #file:.github/specs/YYYY-MM-DD-spec-name/spec.md
  </header>
</file_template>
...
<file_template>
  <header>
    ...
    This is the API specification for the spec detailed in #file:.github/specs/YYYY-MM-DD-spec-name/spec.md
  </header>
</file_template>
...
<review_request>
  ...
  - Spec Requirements: #file:.github/specs/YYYY-MM-DD-spec-name/spec.md
  - Spec Summary: #file:.github/specs/YYYY-MM-DD-spec-name/spec-lite.md
  - Technical Spec: #file:.github/specs/YYYY-MM-DD-spec-name/sub-specs/technical-spec.md
...
<conditional_reads>
  ...
  <manual_reads>
    <mission_lite>
      - IF NOT already in context: READ #file:.github/product/mission-lite.md
      - IF already in context: SKIP reading
    </mission_lite>
    <roadmap>
      - IF NOT already in context: READ #file:.github/product/roadmap.md
      - IF already in context: SKIP reading
    </roadmap>
    <decisions>
...
<decision_analysis>
  <review_against>
    - #file:.github/product/mission-lite.md (conditional)
    - #file:.github/product/roadmap.md (conditional)
  </review_against>
  <criteria>
...
<decision_template>
  ...
  **Related Spec:** #file:.github/specs/YYYY-MM-DD-spec-name/
...
<execution_flow>
  IF user_confirms_yes:
    REFERENCE:#file:.github/instructions/core/execute-tasks.md
...
<standards>
  <follow>
    - #file:.github/product/code-style.md
    - #file:.github/product/dev-best-practices.md
