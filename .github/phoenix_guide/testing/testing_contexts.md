...
> **Requirement**: This guide expects that you have gone through the [Contexts guides](contexts.md).
...
There are some considerations you need to have in mind when running asynchronous tests with the sandbox, so please refer to the [`Ecto.Adapters.SQL.Sandbox`](https://hexdocs.pm/ecto_sql/Ecto.Adapters.SQL.Sandbox.md) for more information.
