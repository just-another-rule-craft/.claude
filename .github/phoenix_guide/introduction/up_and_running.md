...
>
> - [Phoenix.HTML](https://hexdocs.pm/phoenix_html/Phoenix.HTML.md), [TailwindCSS](https://tailwindcss.com), and [Esbuild](https://esbuild.github.io) for HTML applications. You can skip them with the `--no-html` and `--no-assets` flags.
>
